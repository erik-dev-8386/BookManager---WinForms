drop database BookManagementDb
go
...
INSERT BookCategory (BookCategoryId, BookGenreType, Description) VALUES 
(1, N'Fiction', N'Fiction is any creative work, chiefly any narrative work, portraying individuals, events, or places that are imaginary, or in ways that are imaginary.')
GO

INSERT BookCategory (BookCategoryId, BookGenreType, Description) VALUES 
(2, N'Science Fiction', N'Science fiction is a genre of speculative fiction, which typically deals with imaginative and futuristic concepts such as advanced science and technology, space exploration, time travel, parallel universes, and extraterrestrial life.')
GO

INSERT BookCategory (BookCategoryId, BookGenreType, Description) VALUES 
(3, N'Historical Fiction', N'Historical fiction is a literary genre in which the plot takes place in a setting related to the past events, but is fictional.')
GO
...
INSERT UserAccount (MemberId, Password, Email, FullName, Role) 
VALUES (1, N'@123Ad', N'admin@bookstore.com', N'Administrator', 1)
GO

INSERT UserAccount (MemberId, Password, Email, FullName, Role) VALUES
(2, N'@123St', N'staff@bookstore.com', N'Staff', 2)
GO

INSERT UserAccount (MemberId, Password, Email, FullName, Role) VALUES 
(3, N'@123Mb1', N'member1@bookstore.com', N'Member 1', 3)
GO

INSERT UserAccount (MemberId, Password, Email, FullName, Role) VALUES 
(4, N'@123Mb2', N'member2@bookstore.com', N'Member 2', 3)
GO
